...
public class CustomerAdditionMenu {
	...
	void startAdding() {
		...
		handling.handleMenuInput(choice, firstname, lastname, emailadress);
	...
	public void fail() {
		// TODO Auto-generated method stub
		System.out.println("ADDITON FAILURE , please retry");
	}
}
